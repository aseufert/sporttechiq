...
class Player(models.Model):
    ...
    user            = models.OneToOneField(User, on_delete=models.SET_NULL, null=True, blank=True, help_text='If you add a new user here, be sure to fill in email field.')
    photo           = models.ImageField(upload_to='players', null=True, blank=True, validators=[file_size_validator.file_size])
    trading_card    = models.ImageField(upload_to='cards', null=True, blank=True, help_text='Autogenerated. Do not load file unless necessary.')
...
class Station(models.Model):
    ...
    index = models.SmallIntegerField(null=True, choices=index_choices, help_text='Used to order stations in showcase')
