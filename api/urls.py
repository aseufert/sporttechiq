...
urlpatterns = [
    ...
    url(r'^showcases$', views.ShowcaseList.as_view()),
    url(r'^showcases/(?P<pk>[0-9]+)$', views.ShowcaseDetail.as_view()),
    ...
    url(r'^scorecards$', views.PlayerScorecardList.as_view()),
    url(r'^scorecards/(?P<pk>[0-9]+)$', views.PlayerScorecardDetail.as_view()),
